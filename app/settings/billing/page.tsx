  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-heading font-bold text-foreground mb-2">Billing & Usage</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
                <h2 className="text-lg font-heading font-semibold text-foreground mb-4">Total Cost (30 Days)</h2>
              ...
              <div className="lg:col-span-2 bg-card rounded-xl border border-border p-6 shadow-sm">
                <h2 className="text-lg font-heading font-semibold text-foreground mb-6">Daily Trend (Stacked)</h2>
            ...
            <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
              <div className="p-6 border-b border-border">
                <h2 className="text-lg font-heading font-semibold text-foreground">Cost Breakdown</h2>
              </div>
