...
// GET /api/adk-agents/[name]/evaluations/[id]/config - Load metrics configuration
...
// POST /api/adk-agents/[name]/evaluations/[id]/config - Save metrics configuration
...
// DELETE /api/adk-agents/[name]/evaluations/[id]/config - Reset to default configuration
