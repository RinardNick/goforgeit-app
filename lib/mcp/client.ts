 ...
 */
export async function validateStdioServer(config: StdioConfig): Promise<ValidationResult> {
 ...
 */
export async function validateSSEServer(config: SSEConfig): Promise<ValidationResult> {
  let client: Client | null = null;
